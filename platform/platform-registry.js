...
(() => {
  ...
  window.GEI_PLATFORM_REGISTRY=Object.freeze({version:'1.0.7',modules:Object.freeze(modules.map(Object.freeze)),get(id){return modules.find(m=>m.id===id)||null},list(){return modules.slice()}});
})();
