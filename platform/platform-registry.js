...
(() => {
  ...
  const modules = [
    ...
    {id:'knowledge',label:'Knowledge Graph',path:'../knowledge/',state:'implemented',description:'Relationship map connecting GEI systems and records.'},
  ...
  window.GEI_PLATFORM_REGISTRY=Object.freeze({version:'1.0.8',modules:Object.freeze(modules.map(Object.freeze)),get(id){return modules.find(m=>m.id===id)||null},list(){return modules.slice()}});
})();
